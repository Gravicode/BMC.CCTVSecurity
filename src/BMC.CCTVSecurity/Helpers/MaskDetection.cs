...
namespace BMC.CCTVSecurity.Helpers.CustomVision
{
    using System;
    ...
    public class MaskDetection
    {
        ...
        private const int imageInputSize = 416 * 416;//512 * 512;

        public MaskDetection(IList<string> labels, int maxDetections = 20, float probabilityThreshold = 0.1f, float iouThreshold = 0.45f)
        {
            this.labels = labels;
        ...
        {
            var extractedBoxes = this.ExtractBoxes(predictionOutputs, MaskDetection.Anchors);
